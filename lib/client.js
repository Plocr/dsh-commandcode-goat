...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const CSS = [
      ...
      '.ccg-bar{flex:1 1 60px;height:6px;border-radius:999px;background:var(--dsw-alias-bg-layer-4,rgba(127,127,127,.2));overflow:hidden}',
      ...
      '.ccg-percent{flex:none;min-width:54px;text-align:right;font-size:12px;font-weight:600;font-variant-numeric:tabular-nums;color:var(--dsw-alias-label-primary,inherit)}',
    ...
    function MeterRow(props) {
      ...
      return h('div', { className: 'ccg-window' },
        ...
        h('div', { className: 'ccg-row' },
          ...
          props.detail === undefined ? null : h('span', { className: 'ccg-muted' }, props.detail)))
    }
