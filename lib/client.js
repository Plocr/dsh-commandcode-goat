...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    /** Seconds remaining until a window's epoch-seconds `resetAt`. */
    ...
    function CommandCodeCard(props) {
      ...
      return h('div', { className: 'ccg-root' },
        ...
        h('div', { className: 'ccg-section' },
          h('div', { className: 'ccg-row' },
            ...
            status === undefined || status === null
              ? null
              : status.hasKey === true
                ? h('span', { className: 'ccg-pill ccg-pill-ok' }, t.keyReady)
        ...
        h('div', { className: 'ccg-section' },
          ...
          advanced
            ? h('div', { className: 'ccg-section' }, TEXT_FIELDS.map(textRow), h('p', { className: 'ccg-hint' }, t.extraIdsHint))
            : null),
        state.dirty === true
          ? h('div', { className: 'ccg-row' },
            h('button', {
